...
p3 - Illuminations: Some excellent illustrations by <ExternalLink externalLinkHref="http://www.google.com/search?q=pete+knifton" externalLinkTitle="Pete Knifton" />. Pete had inked a number of the pictures in the previous issue of White Dwarf (<Link to="/issues/white-dwarf-magazine-101">101</Link>) and in the newly released Dark Future material. He went on to do lots more great work, as you can see for yourself, if you're interested.  
...
p19 - An extensive article featuring the background and army list from the aforementioned <ExternalLink externalLinkHref="http://boardgamegeek.com/boardgame/26343/warhammer-armies" externalLinkTitle="Warhammer Armies" />, for <ExternalLink externalLinkHref="http://en.wikipedia.org/wiki/Fimir" externalLinkTitle="Fimir" /> (WFB 3rd Ed.). Although as it happens they only turned up as Allies in my edition, rather than a full race, which is presented here. There are also WFRP rules and a Fimir related adventure.  
  
p33 - <ExternalLink externalLinkHref="http://en.wikipedia.org/wiki/Dark_Future" externalLinkTitle="Dark Future" /> is released. Think Mad Max in model form. The game wasn't too dissimilar to Steve Jackson's <ExternalLink externalLinkHref="http://en.wikipedia.org/wiki/Car_Wars" externalLinkTitle="Car Wars" /> which inevitably spawned a series of adventure game books of the same name!  
...
p54 - Chapter Approved: Introducing Eldar War Walkers (W40k 1st Ed.). For the record this article was reproduced in the <ExternalLink externalLinkHref="http://boardgamegeek.com/boardgame/30708/warhammer-40000-compendium" externalLinkTitle="Warhammer 40k Compendium" />. Included in the piece was the inspirational "Today's though - Hope is the beginning of unhappiness"!  
...
p64 - New characters for Games Workshop's board game "<ExternalLink externalLinkHref="http://en.wikipedia.org/wiki/Curse_of_the_Mummy%27s_Tomb_%28board_game%29" externalLinkTitle="Curse of the Mummy's Tomb" />".  
  
p67 - Daemonic Names: An extract from the <ExternalLink externalLinkHref="http://rpggeek.com/rpgitem/46076/realm-of-chaos-slaves-to-darkness" externalLinkTitle="Slaves to Darkness" /> supplement for Chaos (WFB 3rd Ed., WFRP and W40k 1st Ed.!) covering how to name your heinous Chaos Daemons.  
