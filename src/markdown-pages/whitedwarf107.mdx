...
p15 - An ad for the Eldar Harlequin jet bike, including rules and stats. Follows on from the <Link to="/issues/white-dwarf-magazine-106">army list</Link> and <Link to="/issues/white-dwarf-magazine-105">background</Link> in the previous months' issues.  
